        ...
        title: Container(
          child: Column(
            ...
            children: [
              ...
              Text("Anna Ainsley", style: Theme.of(context).textTheme.bodyLarge),
            ],
          ),
        ),
        actions: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        ServiceCircleWidget(radius: 24, onTap: () {}, text: "Hospital", imgUrl: "assets/images/hospital.png"),
                        SizedBox(
                          width: kwidth * 0.1,
                        ),
                        ServiceCircleWidget(
                        ...
                        ServiceCircleWidget(radius: 21, onTap: () {}, text: "Clinic", imgUrl: "assets/images/clinic.png"),
                      ],
                    ),
                    SizedBox(
                      height: kheight * 0.02,
